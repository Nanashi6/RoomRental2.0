...
namespace RoomRental.Migrations
{
    ...
    [Migration("20231212174335_RentalsFix")]
    partial class RentalsFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RoomRental.Models.Building", b =>
                {
                    ...
                    b.HasIndex(new[] { "OwnerOrganizationId" }, "IX_Buildings_ownerOrganizationId");
            ...
            modelBuilder.Entity("RoomRental.Models.Invoice", b =>
                {
                    ...
                    b.HasIndex(new[] { "RentalOrganizationId" }, "IX_Invoices_rentalOrganizationId");

                    b.HasIndex(new[] { "ResponsiblePersonId" }, "IX_Invoices_responsiblePersonId");

                    b.HasIndex(new[] { "RoomId" }, "IX_Invoices_roomId");
            ...
            modelBuilder.Entity("RoomRental.Models.Rental", b =>
                {
                    ...
                    b.HasIndex(new[] { "RentalOrganizationId" }, "IX_Rentals_rentalOrganizationId");

                    b.HasIndex(new[] { "RoomId" }, "IX_Rentals_roomId");
            ...
            modelBuilder.Entity("RoomRental.Models.Room", b =>
                {
                    ...
                    b.HasIndex(new[] { "BuildingId" }, "IX_Rooms_buildingId");
